...
namespace CodingJar.MultiScene
{
	...
	public static partial class AmsPreferences
	{
		...
		[SettingsProvider()]
		static SettingsProvider AmsPreferencesSettingsProvder()
		{
			return new SettingsProvider( "Preferences/Advanced Multi-Scene", SettingsScope.User, new string[] { "AMS", "Multi-Scene", "References", "Cross-Scene" } ) {
				guiHandler = (string searchContext) => { AmsPreferencesOnGUI(); }
			};
		}
